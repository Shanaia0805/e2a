...
var errorCodeCatalog = []errorCodeContract{
	...
	{Code: "batch_hitl_unsupported", Status: "403", Family: "auth"},
	...
	{Code: "too_many_messages", Status: "400", Family: "validation", DetailsSchema: "TooManyMessagesDetails"},
	{Code: "duplicate_recipient", Status: "400", Family: "validation", DetailsSchema: "DuplicateRecipientDetails"},
