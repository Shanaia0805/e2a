...
class EmailSentData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_email", "batch_id", "bcc", "cc", "conversation_id", "direction", "from", "message_id", "message_type", "method", "provider_message_id", "subject", "to"]
